# Chapter 1 – Overview of Fabric CI/CD
...
<img src="./images/OverviewOfFabricCiCd/media/image1.png"
style="width:3.07918in;height:1.29558in" />
...
<img src="./images/OverviewOfFabricCiCd/media/image2.png"
style="width:4.08364in;height:1.2328in" />
...
<img src="./images/OverviewOfFabricCiCd/media/image3.png"
style="width:2.87284in;height:1.59735in"
...
<img src="./images/OverviewOfFabricCiCd/media/image4.png"
style="width:2.78156in;height:2.36531in" />
...
<img src="./images/OverviewOfFabricCiCd/media/image5.png"
style="width:5.71584in;height:1.47818in" />
...
<img src="./images/OverviewOfFabricCiCd/media/image6.png"
...
<img src="./images/OverviewOfFabricCiCd/media/image7.png"
style="width:4.91786in;height:1.74766in" />

As you design a CI workflow for the development process, one option is
to use the **main** branch as the integration branch.

<img src="./images/OverviewOfFabricCiCd/media/image8.png"
style="width:3.26816in;height:1.77431in" />

Alternately, you could design a more intricate workflow that uses the
**dev** branch as the integration branch.

<img src="./images/OverviewOfFabricCiCd/media/image9.png"
style="width:5.97022in;height:2.00002in" />
...
<img src="./images/OverviewOfFabricCiCd/media/image10.png"
style="width:4.10692in;height:1.41042in" />
...
<img src="./images/OverviewOfFabricCiCd/media/image11.png"
style="width:4.09779in;height:1.60117in" />
...
<img src="./images/OverviewOfFabricCiCd/media/image12.png"
style="width:3.09137in;height:1.62818in"
...
<img src="./images/OverviewOfFabricCiCd/media/image13.png"
...
<img src="./images/OverviewOfFabricCiCd/media/image14.png"
...
<img src="./images/OverviewOfFabricCiCd/media/image15.png"
style="width:3.6811in;height:0.76713in" />
...
<img src="./images/OverviewOfFabricCiCd/media/image16.png"
style="width:4.60899in;height:1.22565in" />
...
<img src="./images/OverviewOfFabricCiCd/media/image17.png"
style="width:7.5in;height:1.53403in" />
...
<img src="./images/OverviewOfFabricCiCd/media/image18.png"
style="width:4.64168in;height:1.55005in" />
...
<img src="./images/OverviewOfFabricCiCd/media/image19.png"
style="width:4.02542in;height:1.23595in" />
...
<img src="./images/OverviewOfFabricCiCd/media/image22.png"
...
<img src="./images/OverviewOfFabricCiCd/media/image23.png"
...
<img src="./images/OverviewOfFabricCiCd/media/image24.png"
...
**logicalid**.
<img src="./images/OverviewOfFabricCiCd/media/image25.png"
style="width:7.5in;height:1.28889in" />
...
<img src="./images/OverviewOfFabricCiCd/media/image26.png"
style="width:2.71067in;height:1.38897in" />
...
<img src="./images/OverviewOfFabricCiCd/media/image27.png"
style="width:2.82045in;height:1.23734in" />
...
<img src="./images/OverviewOfFabricCiCd/media/image28.png"
...
<img src="./images/OverviewOfFabricCiCd/media/image29.png"
style="width:4.82144in;height:1.70313in" />\\
...
<img src="./images/OverviewOfFabricCiCd/media/image30.png"
style="width:4.37674in;height:1.72233in" />
...
<img src="./images/OverviewOfFabricCiCd/media/image20.png"
style="width:3.00177in;height:0.97116in" />
...
<img src="./images/OverviewOfFabricCiCd/media/image31.png"
style="width:5.08119in;height:3.36723in" />
...
Now that you've seen your options for how to write the code for Fabric
CI/CD tasks, the next question is where to deploy that code. The answer
to this question is simple. You want to deploy and run your code in the
same GIT repository that holds the item definitions. The next two
...
<img src="./images/OverviewOfFabricCiCd/media/image32.png"
style="width:3.73236in;height:0.98631in" />

Azure Pipelines is the CI/CD workflow service that's built into Azure
DevOps. Azure pipelines service provide features to integrate, test and
deploy code using the principals of CI/CD. An Azure pipeline can be
configured to run on-demand or on a schedule such as every night at
midnight. Alternately, you can define an Azure pipeline with a trigger
to run automatically in response to a code commit or the completion of a
pull request.
...
register it with the Azure pipelines service. This can be accomplished
...
<img src="./images/OverviewOfFabricCiCd/media/image33.png"
style="width:4.30698in;height:1.88071in" />
...
script with the code from the YAML file. The following screenshot shows
an example of three YAML files for three Azure pipelines in the
**.pipelines** folder and their associated Python scripts in the **src**
folder. Below these two folders you can also see the **workspace**
folder which contains the item definitions for a specific workspace.

<img src="./images/OverviewOfFabricCiCd/media/image34.png"
style="width:2.05788in;height:2.01697in" />

As you begin to develop Azure pipelines for a Fabric CI/CD project, you
will find you need some way to track environment settings such as the
...
<img src="./images/OverviewOfFabricCiCd/media/image35.png"
...
When you mark a variable as a secret, the Azure pipelines service does
...
Second, the value cannot be viewed in the Azure DevOps UI after saving.
Third, the secret value is masked in logs. If the secret value appears
in pipeline output, Azure Pipelines replaces it with \*\*\* so it won't
be visible in build logs.
...
group to ensure your Azure pipelines you create have access to variables
and secrets. These permissions can be configured using the **Pipeline
permissions** dialog in the Azure Devops user interface or by using the
Azure DevOps CLI or the Azure REST APIs.

<img src="./images/OverviewOfFabricCiCd/media/image36.png"
style="width:3.1in;height:1.48237in" />

As you begin to developer Azure pipelines, you will want to become
familiar with monitoring pipeline runs in order to test and debug your
code. It's important to add logging to your code to report on successful
operations as well as errors that occur. The following screenshot shows
how an Azure pipeline can be written to log it progress in a Fabric
CI/CD workflow.

<img src="./images/OverviewOfFabricCiCd/media/image37.png"
style="width:4.75734in;height:1.86814in" />
...
<img src="./images/OverviewOfFabricCiCd/media/image38.png"
style="width:4.88323in;height:2.14862in" />

GitHub Actions is the CI/CD platform in GitHub that allows you to
automate build, test, and deployment pipelines. You can create GitHub
actions workflows that can be run on-demand or run on a schedule. You
can also configure workflows to run in response to events such as a code
commit or the completion of a pull request.

With GitHub Actions, you create a workflow by copying a YAML file into a
special system folder named **.github/workflows**. Unlike Azure
pipelines, there is no need to register the YAML file with GitHub. Just
coping to file into the **.github/workflows** folder is all you need to
do. Inside the YAML file, you can reference a script written in a
language such as PowerShell or Python. The following screenshot shows
all the files for a Fabric CI/CD project in a GitHub repository.

<img src="./images/OverviewOfFabricCiCd/media/image39.png"
...
You can view and create secrets by navigating to **Settings** page for a
repository and then selecting the **Secrets and variables \> Actions**
link in the left navigation. When you create a secret, GitHub will
encrypt its value and redact it from logs. A GitHub Action workflow
decrypts a secret at runtime, injected into your workflow, then
immediately discards from memory when the workflow completes.

<img src="./images/OverviewOfFabricCiCd/media/image40.png"
style="width:4.59134in;height:1.20778in" />

You can also add variables to a GitHub repository for environment
settings that are not sensitive. The following screenshot shows the
typical set of variables created for Azure pipelines in a Fabric CI/CD
project.

<img src="./images/OverviewOfFabricCiCd/media/image41.png"
style="width:4.04904in;height:2.36307in" />

While you can create secrets and variables at the repository level, you
can achieve greater levels of granularity by using environments to a
GitHub repository. Consider a scenario where some workspaces in a Fabric
CI/CD project exist within different Entra Id tenants. For example,
imagine there are three different Entra Id tenants for **dev**, **test**
and **prod**. In this scenario, you will need different authentication
credentials for each Entra Id tenant.

You can start by creating three different environments for **dev**,
**test** and **prod**.

<img src="./images/OverviewOfFabricCiCd/media/image42.png"
style="width:3.56817in;height:1.233in" />

After that, you can configure each environment with the authentication
credentials specific to its Entra Id tenant.

<img src="./images/OverviewOfFabricCiCd/media/image43.png"
style="width:2.84185in;height:1.91641in" />
...
navigation of the **Actions** page. You can select a workflow to drill
down see its run history.

<img src="./images/OverviewOfFabricCiCd/media/image44.png"
style="width:3.74109in;height:1.44447in" />

After selecting a workflow in the left navigation, you can run it on
...
running the workflow, you can define input fields in the workflow's YAML
file. The following screenshot shows an example of a workflow that
defines input parameters for a textbox and two checkboxes.

<img src="./images/OverviewOfFabricCiCd/media/image45.png"
style="width:2.05258in;height:1.93416in" />

As you begin to develop workflows with GitHub Actions, you will want to
...
successful operations as well as errors that occur. The following
screenshot shows how an Azure pipeline can be written to log it progress
in a Fabric CI/CD workflow.

<img src="./images/OverviewOfFabricCiCd/media/image46.png"
style="width:4.34392in;height:2.5251in" />
